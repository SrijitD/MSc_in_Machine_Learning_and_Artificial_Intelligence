...
- [Course 1 - PreLaunch Preparatory Content](Course_1-PreLaunch_Preparatory_Content)
  - [Module 1 - Introduction to Python Programming](Course_1-PreLaunch_Preparatory_Content/Module_1-Introduction_to_Python_Programming)
    - [Basics of Python](Course_1-PreLaunch_Preparatory_Content/Module_1-Introduction_to_Python_Programming/1-Basics_of_Python)
    - [Data Structures in Python](Course_1-PreLaunch_Preparatory_Content/Module_1-Introduction_to_Python_Programming/2-Data_Structures_in_Python)
    - [Control Structures and Functions](Course_1-PreLaunch_Preparatory_Content/Module_1-Introduction_to_Python_Programming/3-Control_Structures_and_Functions)
    - [Object-Oriented Programming in Python](Course_1-PreLaunch_Preparatory_Content/Module_1-Introduction_to_Python_Programming/4-Object-Oriented_Programming_in_Python)
  - [Module 2 - Python Libraries](Course_1-PreLaunch_Preparatory_Content/Module_2-Python_Libraries)
    - [NumPy](Course_1-PreLaunch_Preparatory_Content/Module_2-Python_Libraries/1-NumPy)
    - [Pandas](Course_1-PreLaunch_Preparatory_Content/Module_2-Python_Libraries/2-Pandas)
  - [Module 3 - Data Visualisation in Python](Course_1-PreLaunch_Preparatory_Content/Module_3-Data_Visualisation_in_Python)
    - [Introduction to Data Visualization with Matplotlib](Course_1-PreLaunch_Preparatory_Content/Module_3-Data_Visualisation_in_Python/1-Introduction_to_Data_Visualization_with_Matplotlib)
    - [Introduction to Data Visualization](Course_1-PreLaunch_Preparatory_Content/Module_3-Data_Visualisation_in_Python/2-Introduction_to_Data_Visualization)
    - [Data Visualisation with Seaborn](Course_1-PreLaunch_Preparatory_Content/Module_3-Data_Visualisation_in_Python/3-Data_Visualisation_with_Seaborn)
  - [Module 4 - Math for Machine Learning](Course_1-PreLaunch_Preparatory_Content/Module_4-Math_for_Machine_Learning)
    - [Introduction to Probability](Course_1-PreLaunch_Preparatory_Content/Module_4-Math_for_Machine_Learning/1-Introduction_to_Probability)
    - [Introduction to Linear Algebra](Course_1-PreLaunch_Preparatory_Content/Module_4-Math_for_Machine_Learning/2-Introduction_to_Linear_Algebra)
    - [Linear Transformations and Matrices](Course_1-PreLaunch_Preparatory_Content/Module_4-Math_for_Machine_Learning/3-Linear_Transformations_and_Matrices)
    - [Differential Calculus](Course_1-PreLaunch_Preparatory_Content/Module_4-Math_for_Machine_Learning/4-Differential_Calculus)
...
- [Course 2 - Introduction to Machine Learning and Cloud](Course_2-Introduction_to_Machine_Learning_and_Cloud)
  - [Module 2 - Introduction to Machine Learning](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_2-Introduction_to_Machine_Learning/)
    - [Understanding Machine Learning](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_2-Introduction_to_Machine_Learning/1-Understanding_Machine_Learning)
    - [The Machine Learning Pipeline](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_2-Introduction_to_Machine_Learning/2-The_Machine_Learning_Pipeline)
    - [The Apriori Algorithm : Theory](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_2-Introduction_to_Machine_Learning/3-The_Apriori_Algorithm_Theory)
  - [Module 3 - Exploratory Data Analysis](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_3-Exploratory_Data_Analysis)
    - [Data Sourcing](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_3-Exploratory_Data_Analysis/1-Data_Sourcing)
    - [Data Cleaning](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_3-Exploratory_Data_Analysis/2-Data_Cleaning)
    - [Univariate Analysis](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_3-Exploratory_Data_Analysis/3-Univariate_Analysis)
    - [Bivariate and Multivariate Analysis](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_3-Exploratory_Data_Analysis/4-Bivariate_and_Multivariate_Analysis)
  - [Module 4 - Basics of RDBMS and SQL Querying](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_4-Basics_of_RDBMS_and_SQL_Querying)
    - [RDBMS and its Features](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_4-Basics_of_RDBMS_and_SQL_Querying/1-RDBMS_and_its_Features)
    - [Basic SQL Querying](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_4-Basics_of_RDBMS_and_SQL_Querying/2-Basic_SQL_Querying)
    - [Advanced SQL Querying](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_4-Basics_of_RDBMS_and_SQL_Querying/3-Advanced_SQL_Querying)
    - [Practice Workbench](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_4-Basics_of_RDBMS_and_SQL_Querying/Practice_Workbench)
  - [Module 5 - Inferential Statistics and Hypothesis Testing](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_5-Inferential_Statistics_and_Hypothesis_Testing)
    - [Introduction to Probability](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_5-Inferential_Statistics_and_Hypothesis_Testing/1-Introduction_to_Probability)
    - [Probability and Probability Distribution](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_5-Inferential_Statistics_and_Hypothesis_Testing/2-Probability_and_Probability_Distribution)
    - [Central Limit Theorem and Confidence Interval](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_5-Inferential_Statistics_and_Hypothesis_Testing/3-Central_Limit_Theorem_and_Confidence_Interval)
    - [Hypothesis Testing with a Single Population](Course_2-Introduction_to_Machine_Learning_and_Cloud/Module_5-Inferential_Statistics_and_Hypothesis_Testing/4-Hypothesis_Testing_with_a_Single_Population)
...
- [Course 3 - Big Data and Cloud](Course_3-Big_Data_and_Cloud)
  - [Module 1 - Introduction to Cloud](Course_3-Big_Data_and_Cloud/Module_1-Introduction_to_Cloud)
    - [Why Cloud?](Course_3-Big_Data_and_Cloud/Module_1-Introduction_to_Cloud/1-Why_Cloud)
    - [Deployment and Service Models](Course_3-Big_Data_and_Cloud/Module_1-Introduction_to_Cloud/2-Deployment_and_Service_Models)
    - [Amazon Web Services](Course_3-Big_Data_and_Cloud/Module_1-Introduction_to_Cloud/3-Amazon_Web_Services)
  - [Module 2 - Working with AWS](Course_3-Big_Data_and_Cloud/Module_2-Working_with_AWS)
    - [AWS CLI](Course_3-Big_Data_and_Cloud/Module_2-Working_with_AWS/1-AWS_CLI)
    - [AWS Services](Course_3-Big_Data_and_Cloud/Module_2-Working_with_AWS/2-AWS_Services)
    - [Applications in AWS](Course_3-Big_Data_and_Cloud/Module_2-Working_with_AWS/3-Applications_in_AWS)
  - [Module 3 - Hadoop Framework](Course_3-Big_Data_and_Cloud/Module_3-Hadoop_Framework)
    - [Hadoop Distributed File System](Course_3-Big_Data_and_Cloud/Module_3-Hadoop_Framework/1-Hadoop_Distributed_File_System)
    - [MapReduce and YARN](Course_3-Big_Data_and_Cloud/Module_3-Hadoop_Framework/2-MapReduce_and_YARN)
...
- [Course 5 - Machine Learning_I](Course_5-Machine_Learning_I)
